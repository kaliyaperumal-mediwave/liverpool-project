...
if (currentLocation === "child") {
    ...
    allLabels.triggersPlaceHolder = "Is there anything that you  have noticed that makes this issue worse for you? Tell us about it here.";
    ...
    allLabels.disabilitiesPlaceHolder = "Tell us about any disabilities or difficulties you might have.";
    allLabels.prevAccessedServiceLabel = "Have you previously accessed any other services?";
    allLabels.listServiceLabel = "Have you accessed any of the following services? (Select all options that are relevant) or select 'Other' to add your service."
