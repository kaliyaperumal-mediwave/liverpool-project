    ...
    methods: {
      ...
      fetchReferral: function () {
        ...
        $("th").on("click", function (event) {
          if ($(event.target).is("div")) event.stopImmediatePropagation();
        });
          ...
          ajax: {
            ...
            dataFilter: function (referralRes) {
              ...
              for (var i = 0; i < referralRes.data.data.length; i++) {
                json.data.push([
                  "<input type='checkbox' class='idcheck' id='" +
                  ...
                  referralRes.data.data[i].referral_provider != "Pending"
                    ? "Sent to " + referralRes.data.data[i].referral_provider
                  ...
                  "<div class='d-flex'><button  onclick='viewPdf(\"" +
                    ...
                    '","' +
                    referralRes.data.data[i].referral_provider +
                    "\")' class='btn-pdf send-pdf'>Send</button></div>",
