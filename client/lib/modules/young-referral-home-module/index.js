...
module.exports = {
  ...
  construct: function (self, options) {
    ...
    self.addDispatchRoutes = function () {
      self.dispatch('/', self.middleware.clearSessionReferral, self.youngRefHome);
    };
    self.youngRefHome = function (req, callback) {
      req.res.header('Cache-Control', 'private, no-cache, no-store, must-revalidate');
      return self.sendPage(req, self.renderer('young_referral_home', {
