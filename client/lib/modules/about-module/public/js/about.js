    ...
    var app = new Vue({
        ...
        methods: {
            ...
            initMaps: function () {
                ...
                childAddress = new google.maps.places.Autocomplete(
                    document.getElementById("txtChildAddress"),
                    {
                        types: ["geocode"],
                    }
                );

                houseHoldAddress = new google.maps.places.Autocomplete(
                    document.getElementById("educLocation"),
                    {
                        types: ["establishment"],
                    }
                );

                parentAddress = new google.maps.places.Autocomplete(
                    document.getElementById("gpParentorCarerLocation"),
                    {
                        types: ["geocode"],
                    }
                );
                ...
                google.maps.event.addListener(
                    ...
                    "place_changed",
                    function () {
                        _self.houseHoldData.profession =
                            houseHoldAddress.getPlace().name +
                            "," +
                            houseHoldAddress.getPlace().formatted_address;
                    }
                );
            ...
            onOptionChange: function (event) {
                ...
                this.sec2dynamicLabel = getDynamicLabels(
                    this.userRole,
                    optionsName.parentialResponsibility
                );
                ...
                if (this.userRole == "child") {
                    if (data.parent[0] != undefined) {
                        ...
                        Vue.set(
                            this.aboutObj,
                            "parentFirstName",
                            data.parent[0].parent_firstname
                        );
                        Vue.set(
                            this.aboutObj,
                            "parentLastName",
                            data.parent[0].parent_lastname
                        );
                        Vue.set(
                            this.aboutFormData,
                            "parentialResponsibility",
                            data.parent[0].parental_responsibility
                        );
                        ...
                        Vue.set(
                            this.aboutFormData,
                            "parentCarerFirstName",
                            data.parent[0].responsibility_parent_firstname
                        );
                        Vue.set(
                            this.aboutFormData,
                            "parentCarerLastName",
                            data.parent[0].responsibility_parent_lastname
                        );
                        Vue.set(
                            this.aboutFormData,
                            "relationshipToYou",
                            data.parent[0].child_parent_relationship
                        );
                        Vue.set(
                            this.aboutFormData,
                            "contactNumber",
                            data.parent[0].parent_contact_number
                        );
                        Vue.set(
                            this.aboutFormData,
                            "emailAddress",
                            data.parent[0].parent_email
                        );
                        Vue.set(
                            this.aboutFormData,
                            "sameHouse",
                            data.parent[0].parent_same_house
                        );
                        Vue.set(
                            this.aboutFormData,
                            "parentOrCarrerAddress",
                            data.parent[0].parent_address
                        );
                        Vue.set(
                            this.aboutFormData,
                            "legalCareStatus",
                            data.parent[0].legal_care_status
                        );
                        Vue.set(
                            this.aboutObj,
                            "referral_progress",
                            data.referral_progress == 20 ? 40 : data.referral_progress
                        );
                    }
                    ...
                    if (data[0].parent[0].child_firstname != null) {
                        ...
                        if (data[0].parent[0].child_name_title != null) {
                            Vue.set(
                                this.aboutObj,
                                "childNameTitle",
                                data[0].parent[0].child_name_title
                            );
                        }
                        ...
                        Vue.set(
                            this.aboutObj,
                            "childFirstName",
                            data[0].parent[0].child_firstname
                        );
                        Vue.set(
                            this.aboutObj,
                            "childLastName",
                            data[0].parent[0].child_lastname
                        );
                        Vue.set(this.aboutObj, "childEmail", data[0].parent[0].child_email);
                        Vue.set(
                            this.aboutObj,
                            "childContactNumber",
                            data[0].parent[0].child_contact_number
                        );
                        Vue.set(
                            this.aboutObj,
                            "childAddress",
                            data[0].parent[0].child_address
                        );
                        Vue.set(this.aboutObj, "sendPost", data[0].parent[0].can_send_post);
                        Vue.set(
                            this.aboutObj,
                            "childGender",
                            data[0].parent[0].child_gender
                        );
                        Vue.set(
                            this.aboutObj,
                            "childIdentity",
                            data[0].parent[0].child_gender_birth
                        );
                        Vue.set(
                            this.aboutObj,
                            "childSexualOrientation",
                            data[0].parent[0].child_sexual_orientation
                        );
                        Vue.set(
                            this.aboutObj,
                            "childEthnicity",
                            data[0].parent[0].child_ethnicity
                        );
                        Vue.set(
                            this.aboutObj,
                            "childCareAdult",
                            data[0].parent[0].child_care_adult
                        );
                        Vue.set(
                            this.aboutObj,
                            "houseHoldName",
                            data[0].parent[0].child_household_name
                        );
                        if (data[0].parent[0].contact_type != null) {
                            Vue.set(
                                this.aboutObj,
                                "contactMode",
                                data[0].parent[0].contact_type
                            );
                        }
                        ...
                        Vue.set(
                            this.aboutFormData,
                            "parentialResponsibility",
                            data[0].parental_responsibility
                        );
                        this.sec2dynamicLabel = getDynamicLabels(
                            this.userRole,
                            data[0].parental_responsibility
                        ...
                        Vue.set(
                            this.aboutFormData,
                            "parentCarerFirstName",
                            data[0].responsibility_parent_firstname
                        );
                        Vue.set(
                            this.aboutFormData,
                            "parentCarerLastName",
                            data[0].responsibility_parent_lastname
                        );
                        Vue.set(
                            this.aboutFormData,
                            "relationshipToYou",
                            data[0].child_parent_relationship
                        );
                        Vue.set(
                            this.aboutFormData,
                            "contactNumber",
                            data[0].parent_contact_number
                        );
                        ...
                        Vue.set(
                            this.aboutFormData,
                            "parentOrCarrerAddress",
                            data[0].parent_address
                        );
                        Vue.set(
                            this.aboutFormData,
                            "legalCareStatus",
                            data[0].legal_care_status
                        );
                        this.allHouseHoldMembers = data[0].parent[0].household_member;
                        Vue.set(
                            this.aboutObj,
                            "referral_progress",
                            data[0].referral_progress == 20 ? 40 : data[0].referral_progress
                        );
                    }
                    ...
                    if (data[0] != undefined && data[0].parent[0] != undefined) {
                        ...
                        if (
                            data[0] &&
                            data[0].parent[0] &&
                            data[0].parent[0].household_member
                        ) {
                            this.allHouseHoldMembers = data[0].parent[0].household_member;
                        } else {
                        ...
                        Vue.set(
                            this.aboutObj,
                            "referral_progress",
                            data[0].prof_referral_progress == 20
                                ? 40
                                : data[0].prof_referral_progress
                        );
                    }
                }
            },
            ...
            saveAndContinue: function () {
                ...
                if (
                    formData.childNameTitle &&
                    formData.contactNumber &&
                    formData.relationshipToYou &&
                    formData.childCareAdult &&
                    formData.parentialResponsibility &&
                    formData.childGender &&
                    formData.parentFirstName &&
                    formData.parentLastName &&
                    formData.childIdentity &&
                    formData.sexAssignedAtBirth &&
                    formData.sendPost &&
                    formData.childAddress &&
                    formData.childFirstName &&
                    formData.childLastName &&
                    formData.childContactNumber &&
                    this.phoneRegex.test(formData.contactNumber) &&
                    this.phoneRegex.test(formData.childContactNumber)
                ) {
                    if (
                        (formData.parentialResponsibility == "no" &&
                            !formData.parentCarerFirstName &&
                            !formData.parentCarerLastName) ||
                        (formData.nhsNumber && !this.nhsRegex.test(formData.nhsNumber)) ||
                        (formData.childEmail &&
                            !this.emailRegex.test(formData.childEmail)) ||
                        (formData.childContactNumber &&
                            !this.phoneRegex.test(formData.childContactNumber)) ||
                        (formData.contactNumber &&
                            !this.phoneRegex.test(formData.contactNumber)) ||
                        (formData.emailAddress &&
                            !this.emailRegex.test(formData.emailAddress))
                    ) {
                ...
                if (responseData && Object.keys(responseData)) {
                    ...
                    if (this.paramValues != undefined) {
                        if (this.paramValues[0] == "sec5back") {
                            ...
                            location.href =
                                "/education?" + url.substring(url.indexOf("?") + 1);
                        }
                    } else {
            ...
            upsertHouseHold: function () {
                ...
                if (houseHoldForm.name) {
                    if (houseHoldForm.mode === "update") {
                        this.allHouseHoldMembers = this.allHouseHoldMembers.map(function (
                            it
                        ) {
                        ...
                        this.allHouseHoldMembers.push(
                            JSON.parse(JSON.stringify(houseHoldForm))
                        );
                    }
            ...
            setCalendarHeight: function (e) {
                ...
                var dob = document.getElementsByClassName(
