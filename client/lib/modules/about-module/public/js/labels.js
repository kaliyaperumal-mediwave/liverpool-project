function getDynamicLabels(currentLocation, responsibilityFlow) {
    ...
    if (currentLocation === "child") {
        ...
        section2Labels.contactLabel = "Your contact number-optional";
        ...
        if (responsibilityFlow === 'no' || responsibilityFlow === 'yes') {
            ...
            section2Labels.guardAddress = "What is your parent/carer's address?-optional";
        ...
        if (responsibilityFlow === 'no') {
            ...
            section2Labels.guardAddress = "What is their address?-optional";
            ...
            section2Labels.guardContactPlacLabel = "Enter phone number";
            section2Labels.guardEmailLabel = "What is your email address? - optional";
            ...
            section2Labels.guardAddress = "What is your address?-optional";
