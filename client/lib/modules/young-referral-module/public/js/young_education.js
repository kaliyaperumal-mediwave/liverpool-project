        ...
        methods: {
            ...
            patchValue: function (data) {
                if (this.userRole == "young") {
                    ...
                    if (data[0].professional2[0].child_education_manual_address && data[0].professional2[0].child_education_manual_address.length) {
                        Vue.set(this, "educationManualAddressData", data[0].professional2[0].child_education_manual_address);
                        this.setReadonlyState(true);
                    }
                    if (data[0].professional2[0].child_education_place) {
                        Vue.set(this.educAndEmpData, "attendedInfo", data[0].professional2[0].child_education_place);
                    }
                    if (data[0].professional2[0].child_profession) {
                        data[0].professional2[0].child_profession = capitalizeFirstLetter(data[0].professional2[0].child_profession);
                        var convertArray = data[0].professional2[0].child_profession.split(",");
                        if (convertArray.indexOf('Education') != -1) {
                            this.showInstitution = true;
                        }
                        this.aboutYourSelf = convertArray;
                    ...
                    Vue.set(this.educAndEmpData, "socialWorkContact", data[0].professional2[0].child_socialworker_contact);
                    if (data[0].professional2[0].child_socialworker_contact_type) {
                        Vue.set(this, "socialWorkContactType", data[0].professional2[0].child_socialworker_contact_type);
                    } else {
                        Vue.set(this, "socialWorkContactType", 'mobile');
                    }
                    Vue.set(this.educAndEmpData, "referral_progress", data[0].referral_progress == 40 ? 60 : data[0].referral_progress);
