                    ...
                    return user.findAll({
                        ...
                        return user.findOne({
                            ...
                            const section2Obj = {
                                ...
                                child_ethnicity: aboutObj[0].parent ? (aboutObj[0].parent[0].child_ethnicity=='Other ethnic group'? aboutObj[0].parent.child_ethnicity_other: aboutObj[0].parent[0].child_ethnicity): aboutObj[0].family[0].child_ethnicity=='Other ethnic group'? aboutObj[0].family[0].child_ethnicity_other:child_ethnicity,
