...
exports.sendReferralData = async ctx => {
    ...
    try {
        ...
        console.log('payload bind Exception ', error)
   ...
   // console.log(ctx.request.body.referralData)
    ...
    if (ctx.request.body.referralData.role == "Professional") {
        payLoad = { //Section 1
            ...
            "07a_professional_name": ctx.request.body.referralData.section1.professional_name + concatString + ctx.request.body.referralData.section1.professional_lastname + concatString + ctx.request.body.referralData.section1.professional_profession,
            ...
            "pat_county": ctx.request.body.referralData.section2.pat_county,
            ...
            "14a_parent_or_carer_details_with_parental_responsibility": ctx.request.body.referralData.section2.parent_name + concatString + ctx.request.body.referralData.section2.parent_lastname + "-" + ctx.request.body.referralData.section2.child_parent_relationship,
            "14b_parent_or_carer_contact_number": ctx.request.body.referralData.section2.parent_contact_type + concatString + ctx.request.body.referralData.section2.parent_contact_number,
            ...
            "20_social_worker_information": ctx.request.body.referralData.section3.child_socialworker + concatString + ctx.request.body.referralData.section3.child_socialworker_firstname ? ctx.request.body.referralData.section3.child_socialworker_firstname : "nil" + concatString + ctx.request.body.referralData.section3.child_socialworker_lastname ? ctx.request.body.referralData.section3.child_socialworker_lastname : "" + concatString + ctx.request.body.referralData.section3.child_socialworker_contact_type ? ctx.request.body.referralData.section3.child_socialworker_contact_type : "" + concatString + ctx.request.body.referralData.section3.child_socialworker_contact ? ctx.request.body.referralData.section3.child_socialworker_contact : "",
            // //section4
        ...
        payLoad = { //Section 1
            ...
            "pat_dob": moment(ctx.request.body.referralData.section1.child_dob).format('DD/MM/YYYY'),
            "01_consent_from_child_to_share_with_camhs_partners": ctx.request.body.referralData.section1.consent_child,
            "01_consent_from_child_to_share_with_camhs_partners": ctx.request.body.referralData.section1.consent_parent,
            "02_consent_from_parent_or_carer_to_share_with_camhs_partners": ctx.request.body.referralData.section1.consent_parent ? ctx.request.body.referralData.section1.consent_parent : "",
            "03_any_reason_not_to_contact_parent_or_carer": ctx.request.body.referralData.section1.contact_parent_camhs + concatString + reason_contact_parent_camhs,
            "04_registered_gp": ctx.request.body.referralData.section1.registered_gp,
            "05_registered_school": ctx.request.body.referralData.section1.gp_school ? ctx.request.body.referralData.section1.gp_school : "",
            //Section 2
            "09_nhs_number_provided": ctx.request.body.referralData.section2.child_NHS ? ctx.request.body.referralData.section2.child_NHS : "",
